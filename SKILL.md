...
This is a **multi-file skill**. This router file stays in context permanently. Phase files are loaded one at a time as needed.

**Context rule:** Keep only this router and **one** phase file loaded at a time. When switching phases, **replace** the previous phase file — do not accumulate them.

## Phase Detection — Load the Right Phase File
