...
| Robinhood Chain Lighter Nautilus planning | `skills/v3/exchanges/lighter-robinhood/SKILL.md` → `/v3/deployments` with `venue: "lighter-robinhood"`                        | PLTR-PERP.LIGHTER-RH, lighter-robinhood-tokyo                  |
